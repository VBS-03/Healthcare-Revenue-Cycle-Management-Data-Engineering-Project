...
df_claims=spark.read.parquet("/mnt/rcmdatalake03/bronze/claims/*.parquet")
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS healthcare_rcm_catalog.silver.claims (
...
# MAGIC MERGE INTO healthcare_rcm_catalog.silver.claims AS target
...
# MAGIC %sql
# MAGIC select * from  healthcare_rcm_catalog.silver.claims