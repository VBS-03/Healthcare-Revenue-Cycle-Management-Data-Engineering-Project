...
df_icd_codes=spark.read.format("parquet").load("/mnt/rcmdatalake03/bronze/icd_codes/")

df_icd_codes.createOrReplaceTempView("staging_icd_codes")

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS healthcare_rcm_catalog.silver.icd_codes (
...
# MAGIC %sql
# MAGIC MERGE INTO
# MAGIC   healthcare_rcm_catalog.silver.icd_codes AS target
# MAGIC USING
...
# MAGIC %sql
# MAGIC Select * from healthcare_rcm_catalog.silver.icd_codes;