...
df_hosa=spark.read.parquet("/mnt/rcmdatalake03/bronze/hosa/patients")
df_hosa.createOrReplaceTempView("patients_hosa")

#Reading Hospital B patient data 
df_hosb=spark.read.parquet("/mnt/rcmdatalake03/bronze/hosb/patients")
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS healthcare_rcm_catalog.silver.patients (
...
# MAGIC MERGE INTO healthcare_rcm_catalog.silver.patients AS target
