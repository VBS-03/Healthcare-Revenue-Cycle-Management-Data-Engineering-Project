...
# MAGIC USING parquet
# MAGIC OPTIONS (
# MAGIC   path "/mnt/rcmdatalake03/bronze/hosa/encounters"
# MAGIC );
# MAGIC
# MAGIC CREATE OR REPLACE TEMP VIEW hosb_encounters
# MAGIC USING parquet
# MAGIC OPTIONS (
# MAGIC   path "/mnt/rcmdatalake03/bronze/hosb/encounters"
# MAGIC );
# MAGIC
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS healthcare_rcm_catalog.silver.encounters (
...
# MAGIC MERGE INTO healthcare_rcm_catalog.silver.encounters AS target
...
# MAGIC %sql
# MAGIC -- Insert new record and update records to implement SCD Type 2
# MAGIC MERGE INTO healthcare_rcm_catalog.silver.encounters AS target USING quality_checks AS source 
...
# MAGIC %sql
# MAGIC Select * FROM healthcare_rcm_catalog.silver.encounters
# MAGIC Where datasource = 'hos-a'