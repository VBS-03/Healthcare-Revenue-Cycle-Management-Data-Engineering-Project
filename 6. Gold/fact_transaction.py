...
# MAGIC %sql
# MAGIC create table if not exists healthcare_rcm_catalog.gold.fact_transactions
# MAGIC (
...
# MAGIC %sql
# MAGIC truncate table healthcare_rcm_catalog.gold.fact_transactions

# COMMAND ----------

# MAGIC %sql
# MAGIC insert into healthcare_rcm_catalog.gold.fact_transactions
# MAGIC select 
...
# MAGIC   from healthcare_rcm_catalog.silver.transactions t 
